...
location_df = pd.read_json(f'{host}/json/location/kitchen', orient='records', convert_dates=True)
plant_df = pd.read_json(f'{host}/json/plant/basil', orient='records', convert_dates=True)
